...
variable database_disk_type {
  description = "database dedicated GCE disk type. Can be either pd-ssd, local-ssd, or pd-standard."
  default     = "pd-ssd"
}

variable database_disk_size_gb {
  description = "database dedicated size of the image in gigabytes."
  default     = 5
}

variable backup_disk_type {
  description = "The backup Volume dedicated GCE disk type. Can be either pd-ssd, local-ssd, or pd-standard."
  default     = "pd-ssd"
}

variable backup_disk_size_gb {
  description = "The backup Volume dedicated size of the image in gigabytes."
  default     = 5
}
